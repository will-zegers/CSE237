...
typedef ap_fixed<32,3> data_t; // Type of the input/output and LUT values. You can change the bitwidth.
...
#define MAN_BITS	3  // Size of fractional part. Vary this number to increase/decrease the resolution.
